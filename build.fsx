...
Target.create "Lib_Build" (fun _ -> build "EventStoreBackup")
//Target.create "Lib_Test" (fun _ -> testSolution "EventStoreBackup")
Target.create "Lib_Test" ignore

Target.create "Lib_Publish" (fun _ -> publish "EventStoreBackup")
Target.create "Lib_Pack" (fun _ -> pack "EventStoreBackup")
